...
$(document).ready(function() {
	...
	/*$("#dataForm").on("submit", function(event) {
		...
		inputsImage.find("img").each(function(i, o) {
			$(o).attr("src", "http://www.simumath.com/tools/hydra/"+$(o).attr("src"));
...
function fillOutput(resultData, time) {
	...
	if(typeof resultData[1] != 'undefined') {
		...
		$("div.hydraResults-"+time+" .TAB1_0.NSW.M_1:last").clone().insertAfter("div.hydraResults-"+time+" .TAB1_0.NSW.M_1:last");
		for(var v = 0; v < cellsCount; v++) {
			$("div.hydraResults-"+time+" .TAB1_0.NSW.M_1:last td:eq("+v+")").html('<input title="Show in Graph" id="TAB1_cb'+(v+1)+'" class="TAB1_0" type="checkbox" points="['+graphArrayOne[1][v]+']" pointsTwo="['+graphArrayTwo[1][v]+']" />');
		}
	...
	if(typeof resultData[2] != 'undefined') {
		...
		for(var v = 0; v < cellsCount; v++) {
			$("div.hydraResults-"+time+" .TAB2_0.NSW.M_"+thisM+":last td:eq("+v+")").html('<input title="Show in Graph" id="TAB2_cb'+(v+1)+'" class="TAB2_0" type="checkbox" points="['+graphArrayOne[2][v]+']" pointsTwo="['+graphArrayTwo[2][v]+']" />');
		}
	...
	if(typeof resultData[3] != 'undefined') {
		...
		for(var v = 0; v < cellsCount; v++) {
			$("div.hydraResults-"+time+" .TAB3_0.NSW.M_"+thisM+":last td:eq("+v+")").html('<input title="Show in Graph" id="TAB3_cb'+(v+1)+'" class="TAB3_0" type="checkbox" points="['+graphArrayOne[3][v]+']" pointsTwo="['+graphArrayTwo[3][v]+']" />');
		}
...
function createPDF(obj) {
	...
	resultsWindow = window.open("http://www.simumath.com/tools/utils/pdf.php?c="+btoa(page), 'hydraPDF', 'width=1024, height=800');
